...
def make_favorite(n):
    return dmc.Group([
            ...
            dmc.Button(
                "Select",
                id={"type": "favorite-fetch", "index": n},
                mt=25
            ),
        ], align="flex-start", mb=20)
        ...
        dmc.Box(
            [
                ...
                dag.AgGrid(
                    id="weather-grid",
                    columnDefs=[
                        {"field":"state", "headerName": "St", "width": 110, "floatingFilter": True},
                        {"field": "icaoId", "headerName": "Airport", "width": 120, "floatingFilter": True},
                        {"field": "name", "headerName": "Name", "width": 200, "floatingFilter": True},
                        {"field": "rawOb", "headerName": "METAR & TAF", "floatingFilter": True,
                            "width": 600,
                             "autoHeight": True,

                                "cellStyle": {"whiteSpace": "pre", "lineHeight": "1.5", "paddingTop":10}
                         },
                        {"field": "wdir", "headerName": "Dir", "width": 80},
                        {"field": "wspd", "headerName": "Speed", "width": 75},
                        {"field": "wgst", "headerName": "Gusts", "width": 75},
                        {"field": "visib", "headerName": "Vis", "width": 75},
                        {"field": "clouds", "headerName": "clouds","width": 200},
                    ],
                    defaultColDef={ "filter": True, "suppressHeaderMenuButton": True},
                    rowData=[],
                    style={"height": 800},
...
def fetch_weather_data(_,  airport_codes):
    if not airport_codes:
        return [], dmc.Alert("Please enter at least one airport code or state", color="yellow")
